    ...
    return (
        <div className="w-full overflow-hidden">
            <MinimalTiptapEditor
                ...
                onChange={onChange}
                throttleDelay={200}
                className="w-full bg-zinc-900 border border-zinc-700 text-zinc-100 rounded-md focus-within:border-zinc-500 focus-within:ring-1 focus-within:ring-zinc-500 overflow-hidden"
                ...
                editable={true}
                injectCSS={true}
                editorClassName="focus:outline-none min-h-[200px] caret-white overflow-hidden"
                assignees={assignees}
            />
        </div>
    )
